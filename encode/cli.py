...
BANNER = f"""\
\033[36m>_\033[0m \033[1mencode\033[0m \033[90mv{__version__}\033[0m
\033[90m   offseckit.com/tools/encode\033[0m
"""
...
@click.pass_context
def main(ctx, op, input_text, steps, text):
    ...
    Examples:
      ...
      echo "encoded data" | encode -o base64-decode
      encode -o hex-encode -i "secret"
      encode list

    \b
    Chain operations with multiple -o flags — output of each step
    feeds into the next. Use --steps to see intermediate results.

    \b
    Part of OffSecKit — https://offseckit.com/tools/encode
    """
    ...
    # Resolve input: -i flag > positional args > stdin
